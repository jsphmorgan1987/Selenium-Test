 ...
 */
public class signedInMILeadPurchase {
    ...
    String lastName = "LFFGNLWG";
    Double SSN = 666835577.0;
    String monthDOB = "September";
    String dayDOB = "07";
    String yearDOB = "1996";
    Double addNumber = 14312.0;
    String streetName = "AVALON RESERVE";
    String streetSuffix = "BLVD APT 103";
    String city = "Orlando";
    String state = "FL";
    Double zip = 32828.0;
    String fullAddress;
    ...
    public signedInMILeadPurchase(WebDriver driver) {
        this.driver = driver;
