...
public class leadRefi {
    ...
    By purchaseMonth = By.id("qz_register_user_persons_0_addresses_0_purchaseDate_month");
    By purchaseYear = By.id("qz_register_user_persons_0_addresses_0_purchaseDate_year");
    By purchasePrice = By.id("qz_register_user_persons_0_addresses_0_purchasePrice");
    By mortgageType = By.id("qz_register_user_persons_0_addresses_0_mortgageTerm");
    By mortgageUnderWater = By.id("qz_register_user_persons_0_mortgageUnderwater");
    By refiContact = By.id("qz_register_user_persons_0_mortgageContact");
    ...
    public leadRefi(WebDriver driver) {
        this.driver = driver;
        driver.get("https://test.qlcredit.com/external-partner?campaign=lola-canem385");
    ...
    public void additionalInformation(String homePhone, String veteran, String ownerShipStatus, String lived, String buying, String personalIncome, String personalSavings)
    {
        ...
        Select purchaseMonthDropDown = new Select(driver.findElement(purchaseMonth));
        purchaseMonthDropDown.selectByVisibleText("January");

        Select purchaseYearDropDown = new Select(driver.findElement(purchaseYear));
        purchaseYearDropDown.selectByVisibleText("2000");

        driver.findElement(purchasePrice).sendKeys("250000");

        Select mortgageTypeDropDown = new Select(driver.findElement(mortgageType));
        mortgageTypeDropDown.selectByVisibleText("20 Year Fixed");
        ...
        Select mortgageUnderwaterDropDown = new Select(driver.findElement(mortgageUnderWater));
        mortgageUnderwaterDropDown.selectByVisibleText("No");

        Select refiContactDropDown = new Select(driver.findElement(refiContact));
        refiContactDropDown.selectByVisibleText("Yes");
