...
public class SummaryTest {
    ...
    public void setUp() {
        ...
        driver = eyes.open(driver, "QL Credit", "Summary");
    }

    @Category({tests.groups.All.class,tests.groups.Test.class})
    @Test
    public void linkCheck() {
        navigate.closeSymfony();
        navigate.with("jsphmorgan+225@gmail.com", "Qup1234!");
