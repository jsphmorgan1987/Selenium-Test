package tests.andersonDevEnvironment;
 ...
 */
public class createAccountAndersonTest {
    private WebDriver driver;
    private accountCreate accountcreate;
    private Eyes eyes;
    DesiredCapabilities capabilities = DesiredCapabilities.chrome();
    Date date = new Date();
    private String environment = "canderson.dev";
    ...
    public void setUp() {
        ...
        driver = eyes.open(driver, "QL Credit", "Account Creation Anderson");
    }

    @Category({tests.groups.All.class,tests.groups.Anderson.class})
    @Test
