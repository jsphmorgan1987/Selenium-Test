 ...
 */
public class homePageKrishnaTest {
    ...
    public void setUp() {
        ...
        driver = eyes.open(driver, "QL Credit", "HomePage Krishna");
        driver.manage().window().setSize(new Dimension(375,667));
    }

    @Category(tests.groups.Krishna.class)
    @Test
    public void screenshot() {
        driver.get("https://krishna.dev.qlcredit.com/");
