package tests.dejanDevEnvironment;
 ...
 */
public class homePageDejanTest {
    private WebDriver driver;
    private String environment = "diskra.dev";
    private Eyes eyes;
    ...
    public void setUp() {
        ...
        driver = eyes.open(driver, "QL Credit", "HomePage Dejan");
        driver.manage().window().setSize(new Dimension(375,667));
    }

    @Category(tests.groups.Dejan.class)
    @Test
    public void screenshot() {
        driver.get("https://diskra.dev.qlcredit.com/");
