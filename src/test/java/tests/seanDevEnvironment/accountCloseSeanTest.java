 ...
 */
public class accountCloseSeanTest {
    ...
    Date date = new Date();
    private String environment = "sean";
    private By myAccount = By.xpath("//*[@id=\"scroll-nav\"]/ul/li[8]/a");
    ...
    public void setUp() {
        ...
        driver = eyes.open(driver, "QL Credit", "Account Close Sean");
    }
