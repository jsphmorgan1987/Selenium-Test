 ...
 */
public class homePageChrisTest {
    ...
    public void setUp() {
        ...
        driver = eyes.open(driver, "QL Credit", "HomePage Chris");
        driver.manage().window().setSize(new Dimension(375,667));
    }

    @Category(tests.groups.Chris.class)
    @Test
    public void screenshot() {
        driver.get("https://chris.dev.qlcredit.com/");
