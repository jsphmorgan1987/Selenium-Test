 ...
 */
public class homePageKellyTest {
    ...
    public void setUp() {
        ...
        driver = eyes.open(driver, "QL Credit", "HomePage Kelly");
        driver.manage().window().setSize(new Dimension(375,667));
    }

    @Category(tests.groups.Kelly.class)
    @Test
    public void screenshot() {
        driver.get("https://kbehr.dev.qlcredit.com/");
